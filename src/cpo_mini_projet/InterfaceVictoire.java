 ...
 * @author saint
 */
public class InterfaceVictoire extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceVictoire
     */
    public InterfaceVictoire() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bravo!! Vous etes la/le meilleur(e)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceVictoire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceVictoire().setVisible(true);
            }
        });
    }
